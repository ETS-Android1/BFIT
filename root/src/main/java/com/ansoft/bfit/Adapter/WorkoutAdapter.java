...
import com.ansoft.bfit.DiscoverWorkoutMoreActivity;
...
public class WorkoutAdapter extends RecyclerView.Adapter<WorkoutAdapter.MyViewHolder> {
    ...
    public WorkoutAdapter(List<Workout> workoutList, AppCompatActivity context, int day, int level, String id) {
    ...
    public void onBindViewHolder(MyViewHolder viewHolder, final int i) {
        ...
        viewHolder.outerView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!id.isEmpty()) {
                    Intent intent = new Intent(context, DiscoverWorkoutMoreActivity.class);
