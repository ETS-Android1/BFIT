...
public class CompletedWorkoutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (activity instanceof WorkoutActivity) {
            ...
            Seconds = (int) (((DiscoverWorkoutActivity) activity).totalTime / 1000);
        }
        ...
        if (activity instanceof WorkoutActivity) {
            ...
            tvCalorieBurned.setText("" + String.format("%.2f", ((DiscoverWorkoutActivity) activity).calculateCaloriesBurned()) + "KCAL");
